...
class DataReader(object):
    ...
    def __init__(self,
        ...
        # loading files
        self.db       = self.loadjson(dbfile, encoding='utf-8')
        self.s2v      = self.loadjson(s2vfile, encoding='utf-8')
        self.semidict = self.loadjson(semifile, encoding='utf-8')
        self.dialog   = self.loadjson(corpusfile, encoding='utf-8')
